...
<body class="hold-transition sidebar-mini">
		...
		<ul class="navbar-nav ml-auto">
			...
			<li class="dropdown user user-menu nav-item">
				<a href="" class="nav-link" data-toggle="dropdown">
					<img src="<?php echo e(asset('template/dist/img/user2-160x160.jpg')); ?>" class="user-image">
					<span class="hidden-xs">Admin</span>
				</a>
				<ul class="dropdown-menu">
					<li class="user-header">
						<img src="<?php echo e(asset('template/dist/img/user2-160x160.jpg')); ?>" class="img-circle">
	...
	<aside class="main-sidebar sidebar-dark-primary elevation-4">
		...
		<img src="<?php echo e(asset('template/dist/img/logo.svg')); ?>" alt="logo" class="brand-image img-circle elevation-3" style="opacity: .8">
...
<?php /**PATH /var/www/html/rvpos/resources/views/dashboard.blade.php ENDPATH**/ ?>